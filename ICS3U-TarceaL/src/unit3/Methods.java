...
public class Methods {
    ...
    Using Static Methods
		...
		System.out.println("This school year I have Computer Science in the first semester.");
    ...
    You as the user don't know how it works, but because someone has made it, you can simply use it again and again.
		...
		// myNum is getting run through the doubleNumber method, which multiplies it by 2, then the return value is printed
		int myNum = 30;
		myNum = doubleNumber(myNum);
		System.out.println(myNum);

		//Explain what is happening
		// 5 is getting run through the doubleNumber method, which multiplies it by 2, then the return value is printed
